	...
	public void actionPerformed(ActionEvent ae)
	{
     ...
     //  l6.setLocation(230, 150);
      ...
      //  Ofset.add(l6);
        ...
        Ofset.setSize(400,400);//400 width and 500 height
...
class Fcm extends JFrame implements ActionListener
{
  ...
  private JTable table;
  JMenuItem openitem;
  JMenuItem openkitem[]=new JMenuItem[12];
  JMenuItem openk2item[]=new JMenuItem[12];

  JMenu sel_distance=null;
  JMenu sel_2distance=null;

   String distances[] = {"Euclidean","V-C","D.V-C","Manhattan","ChessBoard","Mean-Absolute-Difference","Canberra","BrayCurtis","Cosine","Correlation","Normalized-Squared-Euclidean","Median-Absolute-Difference"};
